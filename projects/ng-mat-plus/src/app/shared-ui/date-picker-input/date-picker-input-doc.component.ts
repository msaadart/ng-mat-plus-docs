  ...
  template: `
    ...
    <ng-template #overviewContent>
      <div class="space-y-4">
        <p class="text-on-surface">
          The <code class="     px-1 py-0.5 rounded text-gray-800">&lt;lib-date-picker&gt;</code> component provides a user-friendly date selection interface with Angular Material integration. It supports form control binding, validation, and customizable display options.
        </p>
    ...
    <ng-template #useCasesContent>
      <div class="space-y-6">    
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-gray-600">Basic Date Picker</h3>
    ...
    <ng-template #otherContent>
      <div class="space-y-6">
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-gray-600">Custom Date Validation</h3>
            <p class="mt-2 text-gray-600">
