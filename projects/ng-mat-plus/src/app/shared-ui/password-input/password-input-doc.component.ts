  ...
  template: `
      ...
      <div class="space-y-4">
        ...
        <div class="   border-blue-500 p-4 my-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-on-primary-container">Security Features</h3>
    ...
    <ng-template #useCasesContent>
      <div class="space-y-6">    
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Basic Password Input</h3>
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Password Confirmation</h3>
            <p class="mt-2 text-on-surface">
    ...
    <ng-template #otherContent>
      <div class="space-y-6">
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Password Strength Meter</h3>
            <p class="mt-2 text-on-surface">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class=" divide-y divide-gray-200">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">The label text for the password field (default: 'Password')</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">placeholder</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">string</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Placeholder text displayed when the input is empty (default: 'Enter your password')</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">showStrengthMeter</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">boolean</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Whether to show password strength meter (default: false)</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export class PasswordInputDocComponent {
  ...
  tsCode = `
    ...
    import { LibPasswordComponent } from 'ng-mat-plus/lib-forms';
