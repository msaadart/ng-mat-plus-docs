  ...
  template: `
    ...
    <ng-template #useCasesContent>
      <div class="space-y-6">    
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Basic Array Form Setup</h3>
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">FormArray with Validation</h3>
            <p class="mt-2 text-on-surface">
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Custom Form Controls</h3>
            <p class="mt-2 text-on-surface">
      ...
      <div class="space-y-4">    
        ...
        <div class="  p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium ">Validation Tips</h3>
              <div class="mt-2 text-sm ">
                <p>
    ...
    <ng-template #otherContent>
      <div class="space-y-6">
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Nested Form Arrays</h3>
            <p class="mt-2 text-on-surface">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class=" divide-y divide-gray-200">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">The main form group containing the FormArray</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">fields</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">FormArray</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Getter for the form array containing all field groups</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">addFieldSet()</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">Method</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Adds a new field group to the form array</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">removeFieldSet(index)</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">Method</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Removes a field group at the specified index</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">onSubmitAll()</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">Method</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Submits all form groups and disables them</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">onEditAll()</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">Method</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Enables all form groups for editing</td>
                </tr>
              </tbody>
            </table>
          </div>
