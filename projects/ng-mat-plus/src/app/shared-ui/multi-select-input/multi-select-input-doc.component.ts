    ...
    <ng-template #overviewContent>
      <div class="space-y-4">
        <p class="text-on-surface">
          The <code class="     px-1 py-0.5 rounded ">&lt;lib-multi-select&gt;</code> component provides a customizable multi-select input with label support, placeholder text, and seamless integration with Angular's reactive forms.
        </p>
        ...
        <div class="   border-blue-500 p-4 my-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-on-primary-container">Multi-Select Features</h3>
    ...
    <ng-template #useCasesContent>
      <div class="space-y-6">    
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Basic Multi-Select Input</h3>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class=" divide-y divide-gray-200">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">The label for the multi-select field (default: 'Select')</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">placeholder</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">string</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Placeholder text (default: 'Choose options')</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">options</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">Array&lt;{{ '{' }}value: any, label: string{{ '}' }}&gt;</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Array of options to display in the multi-select</td>
                </tr>
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">The FormControl instance for the multi-select field</td>
                </tr>
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">Whether the multi-select is disabled (default: false)</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export class MultiSelectInputDocComponent {
  ...
  tsCode = `
    ...
    import { LibMultiSelectComponent } from 'ng-mat-plus/lib-forms';
