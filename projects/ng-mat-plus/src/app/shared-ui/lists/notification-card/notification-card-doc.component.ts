...
import { LibNotificationCardComponent } from 'ng-mat-plus/lib-lists';
      ...
      <div class="space-y-4">    
        <div class="          p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium  ">Interaction Notes</h3>
        ...
        <div class="  p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium ">Content Recommendations</h3>
              <div class="mt-2 text-sm ">
                <p>
...
export class NotificationCardDocComponent {
  ...
  tsCode = `
    ...
    import {{ '{' }} LibDataTransferService {{ '}' }} from 'ng-mat-plus/lib-lists';
