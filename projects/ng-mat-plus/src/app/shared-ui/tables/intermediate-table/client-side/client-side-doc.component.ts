...
editRow(row: User) {
  ...
  tsCode = `
    ...
    import { LibDialogService, LibToastService } from 'ng-mat-plus/services';
    import { TablePopupComponent } from '../../table-popup/table-popup.component';
    import { TIntermediateTableColumn, IntermediateTableColumnTypeEnum, IntermediateTableInputTypeEnum, IIntermediateTableRowConfig } from 'ng-mat-plus/utilis';
    import { LibIntermediateClientTableComponent } from "ng-mat-plus/lib-tables";
    import { LibTextFieldComponent, LibNumberComponent, LibDatePickerComponent } from 'ng-mat-plus/lib-forms';
