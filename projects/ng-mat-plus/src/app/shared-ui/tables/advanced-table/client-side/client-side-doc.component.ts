  ...
  <div class="space-y-4">    
    <div class="          p-4">
      <div class="flex">
        ...
        <div class="ml-3">
          <h3 class="text-sm font-medium  ">Configuration Considerations</h3>
...
export class ClientSideDocComponent {
  ...
  tsCode = `
    ...
    } from 'ng-mat-plus/utilis';
    import { LibDialogService, LibToastService } from 'ng-mat-plus/services';
    import { DateFormat } from 'ng-mat-plus/enums';
    import { LibAdvancedClientTableComponent } from 'ng-mat-plus/lib-tables';
  ...
  rowConfigExample = `
    ...
    import { IAdvancedTableRowConfig } from 'ng-mat-plus';
    import { IAdvancedTableRowConfig } from 'ng-mat-plus/utilis';
