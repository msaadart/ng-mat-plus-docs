...
import { LibHttpService, LibDialogService, LibToastService } from 'ng-mat-plus/services';
import { LibBasicServerTableComponent } from 'ng-mat-plus/lib-tables';
import { TBasicTableColumn, BasicTableColumnTypeEnum, IBasicTableRowConfig, IBasicTableLoadMoreData, IBasicTablePageEvent } from 'ng-mat-plus/utilis';
...
export class ServerSideTableComponent {
  ...
  columnsConfig: TBasicTableColumn<User>[] = [
    ...
    },
    {
      ...
      stickyStart: true,
      commonClass: 'tbl-col-width-per-20 text-three-ellipsis',
    },
    {
      key: 'lastName',
      label: 'Last Name',
      type: BasicTableColumnTypeEnum.Text,
      commonClass: 'tbl-col-width-per-80',
    },
    {
      key: 'age',
      label: 'Age',
    ...
    },
    {
      ...
      label: 'Email',
      type: BasicTableColumnTypeEnum.Text,
      commonClass: 'tbl-col-width-per-25',
