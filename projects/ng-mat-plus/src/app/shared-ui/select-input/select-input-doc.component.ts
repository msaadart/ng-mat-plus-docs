      ...
      <div class="space-y-4">
        ...
        <div class="   border-blue-500 p-4 my-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-on-primary-container">Select Input Features</h3>
    ...
    <ng-template #useCasesContent>
      <div class="space-y-6">    
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Basic Select Input</h3>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class=" divide-y divide-gray-200">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">The label for the select field (default: 'Select')</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">placeholder</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">string</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Placeholder text (default: 'Select an option')</td>
                </tr>
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">Array of options to display in the select</td>
                </tr>
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">The FormControl instance for the select field</td>
                </tr>
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">Whether the select is disabled (default: false)</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export class SelectInputDocComponent {
  ...
  tsCode = `
    ...
    import { LibSelectComponent } from 'ng-mat-plus/lib-forms';
