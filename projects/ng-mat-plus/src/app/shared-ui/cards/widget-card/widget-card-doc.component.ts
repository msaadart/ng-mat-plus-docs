      ...
      <div class="space-y-4">    
        <div class="          p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium  ">Content Projection Notes</h3>
        ...
        <div class="  p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium ">Action Button Tips</h3>
              <div class="mt-2 text-sm ">
                <p>
...
publishedDate = '2025-11-08';
  ...
  tsCode = `
    ...
    import { LibWidgetComponent, IWidgetHeaderIconButtonConfig } from 'ng-mat-plus/lib-cards';
