  ...
  template: `
    ...
    <ng-template #overviewContent>
      <div class="space-y-4">
        <p class="text-on-surface">
          The <code class="     px-1 py-0.5 rounded ">&lt;lib-phone&gt;</code> component is a specialized input field for phone numbers with built-in validation and formatting. It provides a user-friendly way to handle phone number inputs while ensuring proper formatting.
        </p>
        ...
        <div class="   border-blue-500 p-4 my-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-on-primary-container">Phone Number Features</h3>
    ...
    <ng-template #useCasesContent>
      <div class="space-y-6">    
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Basic Phone Input</h3>
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">International Numbers</h3>
            <p class="mt-2 text-on-surface">
    ...
    <ng-template #otherContent>
      <div class="space-y-6">
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-on-surface">Country Code Selection</h3>
            <p class="mt-2 text-on-surface">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class=" divide-y divide-gray-200">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-on-surface">The label text for the phone field (default: 'Phone Number')</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">placeholder</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">string</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Placeholder text displayed when the input is empty (default: 'Enter phone number')</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-on-surface">defaultCountry</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">string</td>
                  <td class="px-6 py-4 text-sm text-on-surface">Default country code (e.g., 'US', 'GB')</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export class PhoneInputDocComponent {
  ...
  tsCode = `
    ...
    import { LibPhoneComponent } from 'ng-mat-plus/lib-forms';
