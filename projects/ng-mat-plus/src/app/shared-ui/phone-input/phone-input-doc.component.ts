  ...
  template: `
    ...
    <ng-template #overviewContent>
      <div class="space-y-4">
        <p class="text-on-surface">
          The <code class="     px-1 py-0.5 rounded text-gray-800">&lt;lib-phone&gt;</code> component is a specialized input field for phone numbers with built-in validation and formatting. It provides a user-friendly way to handle phone number inputs while ensuring proper formatting.
        </p>
    ...
    <ng-template #useCasesContent>
      <div class="space-y-6">    
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-gray-600">Basic Phone Input</h3>
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-gray-600">International Numbers</h3>
            <p class="mt-2 text-gray-600">
    ...
    <ng-template #otherContent>
      <div class="space-y-6">
        ...
        <div class=" shadow rounded-lg overflow-hidden">
          <div class="p-5">
            <h3 class="text-lg font-medium text-gray-600">Country Code Selection</h3>
            <p class="mt-2 text-gray-600">
          ...
          <div class="  px-5 py-3 border-t border-gray-200">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class=" divide-y divide-gray-200">
                ...
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-600">defaultCountry</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">string</td>
