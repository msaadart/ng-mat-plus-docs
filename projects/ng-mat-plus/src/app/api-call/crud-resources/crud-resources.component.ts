              ...
              <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center space-x-2">
                  <span
                    ...
                    [class]="
                      getStatusBadgeClass(
                        usersResource.list.loading(),
                        usersResource.list.error()
                      )
                    "
                  >
                    {{
                  ...
                  <lib-mat-flat-button
                    (matClick)="usersResource.list.reload()"
                    size="small"
                    class="text-sm"
                  >
                    Refresh
              ...
              <div class="max-h-[1350px] overflow-y-auto space-y-3">
                ...
                <div
                  ...
                  <div class="flex justify-end">
                    <lib-mat-flat-button (click)="$event.stopPropagation();" (matClick)="detailUser(user.id);">Detail User</lib-mat-flat-button>
                  </div>
                </div>
                }
              </div>
...
export class CrudResourceComponent {
  ...
  createNewUser(): void {
    ...
    this.usersResource.create(payload);
  ...
  submitUpdateUser(): void {
    ...
    this.usersResource.update(this.updateForm.id, this.updateForm);
  }
  ...
  prefillUpdateUser(id: number): void {
    this.usersResource.update(id, this.updateForm);
    const user = this.usersResource.list.data()?.users?.find(u => u.id === id);
    if (user) {
   ...
   */
  refreshAllData(): void {
    this.usersResource.list.reload();
  }
