...
<header class="bg-gray-900 text-white py-6 md:py-12">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-3xl md:text-4xl font-bold text-center">ng-mat-plus</h1>
    ...
    <section class="mb-12">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="p-6 md:p-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-gray-900">About ng-mat-plus</h2>
                <p class="mt-4 text-gray-600 text-sm md:text-base">
                    <code class="bg-gray-100 px-1 py-0.5 rounded">ng-mat-plus</code> is a modern Angular component
            ...
            <div class="p-6 md:p-8">
                ...
                <p class="mt-4 text-gray-600 text-sm md:text-base">
                    Follow these steps to install and set up <code
                        class="bg-gray-100 px-1 py-0.5 rounded">ng-mat-plus</code> in your Angular project.
                </p>
                <div class="space-y-6 mt-6">
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 p-4 mt-2 rounded-lg">
                            <pre class="text-sm text-gray-800"><code>npm install ng-mat-plus</code></pre>
                        </div>
                    </div>
            ...
            <div class="p-6 md:p-8">
                ...
                <p class="mt-4 text-gray-600 text-sm md:text-base">
                    Discover the full range of components available in <code
                        class="bg-gray-100 px-1 py-0.5 rounded">ng-mat-plus</code> through our Storybook.
                </p>
...
<footer class="bg-gray-900 text-white py-6">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <p class="text-sm md:text-base">© 2025 ng-mat-plus. All rights reserved.</p>
    </div>
</footer>
  `,
  styles: [``],
